...
/**
 * Represents the alignment of a window.
 *
 * @package Atatusoft\Termutil\UI\Windows
 */
final readonly class WindowAlignment
{
    /**
     * WindowAlignment constructor.
     *
     * @param HorizontalAlignment $horizontalAlignment The horizontal alignment of the window.
     * @param VerticalAlignment $verticalAlignment The vertical alignment of the window.
     */
